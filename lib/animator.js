  ...
  (0, _createClass3.default)(_class, [{
    ...
    value: function value() {
      ...
      if (this[_readyDefer] && !this[_readyDefer].timerID) {
        this[_readyDefer].timerID = this.timeline.setAlarm(time, function () {
          if (_this2.timeline.currentTime >= 0) {
            _this2[_readyDefer].resolve();
            _this2.timeline.clearAlarm(_this2[_readyDefer].timerID);
    ...
    value: function value() {
      ...
      var time = duration * iterations + endDelay;
      if (this[_finishedDefer] && !this[_finishedDefer].timerID) {
        this[_finishedDefer].timerID = this.timeline.setAlarm(time, function () {
          _this3[_finishedDefer].resolve();
          _this3.timeline.clearAlarm(_this3[_finishedDefer].timerID);
        }, false);
